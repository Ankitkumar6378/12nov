...
<label >Address :</label>
<input type="text"   placeholder="address with pin code" / name="address" id="add" required><br/>

<label   >Mobile No :</label>
<input type="number" placeholder="eg. phone number"id="mn" name="mobile"required ><br/>
 
<label  >Password :</label>
<input type="password" id="pwd" placeholder="eg. Abc@1" name="password" required ><br/>
